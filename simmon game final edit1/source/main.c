...
int notes1[50] = {392, 392, 587, 587, 659, 659, 587, 523, 523, 493, 493, 440, 440, 392, 493, 493, 493, 523, 587, 493, 440, 392, 392, 392, 440, 493, 440, 392, 493, 493, 523, 587, 587, 523, 493, 440, 392, 392, 440, 493, 440, 392 , 392};
unsigned short timeHeld1[50] = {25, 25, 25, 25, 25, 25, 50, 25, 25, 25, 25, 25, 25, 50, 25, 12, 12, 25, 25, 50, 50, 25, 12, 12, 25, 25, 50, 50,25, 25, 25, 25, 25, 25, 25, 25, 25, 25, 25, 25, 25, 25, 25};
		 ...
		 set_PWM(notes1[n]);	//index++ every timeHeld
		    ...
		    case 659:
		      ...
		      break;
		       ...
		       set_PWM(notes1[n+28]);	//index++ every timeHeld
		    switch(notes1[n+28]){
		    case 392:
		      PORTD |= (1);
		      break;
