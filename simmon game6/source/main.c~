...
int notes[42] = {392, 392, 587, 587, 659, 659, 587, 523, 523, 493, 493, 440, 440, 392, 493, 493, 523, 587, 587, 523, 493, 440, 392, 392, 440, 493, 440, 392 , 587, 587, 493, 440, 493, 587, 440, 493, 587, 440, 392};
unsigned short timeHeld[42] = {25, 25, 25, 25, 25, 25, 50, 25, 25, 25, 25, 25, 25, 50, 25, 25, 25, 25, 25, 25, 25, 25, 25, 25, 25, 25, 50, 50, 25, 25, 25, 25, 25, 50, 25, 25, 25, 25, 50};
...
unsigned char  a[42]= {0x01, 0x01, 0x10, 0x10, 0x20 , 0x20, 0x10, 0x08, 0x08, 0x04, 0x04, 0x02, 0x02, 0x01, 0x04, 0x04, 0x08, 0x10, 0x10, 0x08, 0x04, 0x02, 0x01, 0x01, 0x02, 0x04, 0x02, 0x01, 0x10, 0x10, 0x04, 0x02, 0x04, 0x10, 0x02, 0x04, 0x10, 0x02, 0x01 };
	...
	switch(Game_state){
		...
		case Game_on:
		  ...
		  if(j==14){
		   ...
		   if(j==28){
		    set_PWM(notes[n+28]);	//index++ every timeHeld
		    switch(notes[n+28]){
		    case 392:
		      PORTD |= (1);
		      break;
