...
const unsigned char EEPROM_Address = 0x1A; //Set location to write to EEPROM
...
int notes[42] = {493, 493， 493，523，587，493，440，392，392，392，440，493，440，587，493, 493, 523, 587, 587, 523, 493, 440, 392, 392, 440, 493, 440, 392 , 392, 587, 587, 493, 440, 493, 587, 440, 493, 587, 440, 392};
...
unsigned char  a[42]= {0x04, 0x04, 0x04, 0x08, 0x10 , 0x04, 0x02, 0x01, 0x01, 0x01, 0x02, 0x04, 0x02, 0x10, 0x04, 0x04, 0x08, 0x10, 0x10, 0x08, 0x04, 0x02, 0x01, 0x01, 0x02, 0x04, 0x02, 0x01, 0x01, 0x10, 0x10, 0x04, 0x02, 0x04, 0x10, 0x02, 0x04, 0x10, 0x02, 0x01 };
...
void check_tick(){
	...
	switch(check_state){
		...
		case check_on:
          ...
          if(j > highest)
				{
					eeprom_write_byte((uint8_t*)10,j/10);
					eeprom_write_byte((uint8_t*)1,j%10);
				}
