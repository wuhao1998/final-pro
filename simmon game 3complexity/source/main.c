...
enum Game_States{Game_init, Game_menu,Game_wait, Game_on, Game_on1, Game_off,Game_off1, Game_endsong, Game_endsong1, Game_wait2, Game_win} Game_state;
...
int notes1[28] = {392, 392, 587, 587, 659, 659, 587, 523, 523, 493, 493, 440, 440, 392};
unsigned short timeHeld1[14] = {25, 25, 25, 25, 25, 25, 50, 25, 25, 25, 25, 25, 25, 50};
...
int main(void)
{
  ...
  ADC_Init();		/* Initialize ADC */
	...
	return 1;
		...
		//		if(ADC_Value <600 )
		//	LCD_String_xy(1, 0, "Switch pressed   ");
		//	else
		//	LCD_String_xy(1, 0, "Switch open      ");
